                         ...
                         <div class="iq-card mb-0">
                            <div class="iq-card-body p-0">
                               ...
                               <div class="iq-feature-list">
                                  ...
                                  <p class="mb-0 mt-2">Music</p>
                                  <div class="d-flex align-items-center my-2 iq-ltr-direction">
                                     <p class="mb-0 mr-2"><i class="lar la-eye mr-1"></i> {{$topview->hitcounter->sum('raw_hits')}}</p>
                         ...
                         @foreach($top_view_video as $topview)
                            <tr>
                               <td>
                                  <div class="media align-items-center">
                                     <div class="iq-movie">
                                        <a href="javascript:void(0);"><img src="{{ asset('uploads/video/thumbnail')}}/{{$topview->thubmnail_image}}" class="img-border-radius avatar-40 img-fluid" alt=""></a>
                                     </div>
                                     <div class="media-body text-white text-left ml-3">
                                        <p class="mb-0">{{$topview->title}}</p>
                                        <small>{{$topview->videodatail->duration}}</small>
                                     </div>
                                  </div>
                               </td>
                               ...
                               <td>Music</td>
                               <td>
                               {{$topview->hitcounter->sum('raw_hits')}} <i class="lar la-eye "></i>
                               </td>
                               <!-- <td>Unsubcriber</td>
                               <td>21 July,2020</td> -->
