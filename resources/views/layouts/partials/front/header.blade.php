               ...
               <div class="row">
                  <div class="col-sm-12">
                     <nav class="navbar navbar-expand-lg navbar-light p-0">
                        ...
                        <a class="navbar-brand" href="{{route('home_page')}}"> <img class="img-fluid logo" src="{{ asset('assets/front_template/images/logo.png')}}" loading="lazy"
                           alt="streamit" /> </a>
                              ...
                              <div class="navbar-right position-relative">
                                 <ul class="d-flex align-items-center justify-content-end list-inline m-0">
                                    ...
                                    <li>
                                       ...
                                       <img src="{{ asset('assets/front_template/images/user/user.jpg')}}" class="img-fluid avatar-40 rounded-circle" loading="lazy"
                                          alt="user">
                                       </a>
                           ...
                           <ul class="d-flex align-items-center list-inline m-0">
                              <li class="nav-item nav-icon">
                                 ...
                                 <div class="search-box iq-search-bar d-search">
                                    <form action="{{route('home.searchVideo')}}" class="searchbox">
                                       <div class="form-group position-relative">
                              ...
                              <li class="nav-item nav-icon">
                                 ...
                                 <img src="{{ asset('assets/front_template/images/user/user.jpg')}}" class="img-fluid avatar-40 rounded-circle" alt="user" loading="lazy">
                                 </a>
                                 <div class="iq-sub-dropdown iq-user-dropdown">
                                    <div class="iq-card shadow-none m-0">
                                       <div class="iq-card-body p-0 pl-3 pr-3">
