<head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="{{ asset('assets/admin_template/css/bootstrap.min.css')}}">
    <!--datatable CSS -->
    <link rel="stylesheet" href="{{ asset('assets/admin_template/css/dataTables.bootstrap4.min.css')}}">
    <!-- Typography CSS -->
    <link rel="stylesheet" href="{{ asset('assets/admin_template/css/typography.css')}}">
    <!-- Style CSS -->
    ...
    <script src="{{ asset('assets/admin_template/js/bootstrap.min.js')}}"></script>
