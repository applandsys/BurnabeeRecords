...
Road no 8, house no 66, niketon, Dhaka, Bangladesh</p>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="iq-contact-list" data-element_type="column">
                        ...
                        <div class="icon-box-content">
                           ...
                           <p class="icon-box-description">+88 01401-114220</p>
                        </div>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="iq-contact-list" data-element_type="column">
                        ...
                        <div class="icon-box-content">
                           ...
                           <p class="icon-box-description">info@burnabeerecords.com</p>
                        </div>
                     </div>
                  </div>
               </div>
               ...
               <div class="wrapper">
                  <form action="{{route('home.contact')}}" method="post" class="wpcf7-form init" novalidate="novalidate" data-status="init">
                     @csrf
