                        ...
                        <div class="col-lg-7 col-md-12">
                           <!-- <a href="javascript:void(0);">
                              <div class="channel-logo" data-iq-gsap="onStart" data-iq-position-x="-150" data-iq-position-y="0" data-iq-duration="1" data-iq-delay=".4">
                                 <img src="{{ asset('assets/front_template/images/logo.png')}}" class="c-logo" alt="streamit" loading="lazy">
                              </div>
                           </a> -->
                           <h1 class="slider-text big-title title text-uppercase"  data-iq-gsap="onStart" data-iq-position-x="-150" data-iq-position-y="0" data-iq-duration="1" data-iq-delay=".4">asdfsdf</h1>
