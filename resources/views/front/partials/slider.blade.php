                        ...
                        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                           ...
                           <div class="trending-list" data-wp_object-in="fadeInUp" data-delay-in="1.2">
                              ...
                              <div class="text-primary title genres">
                                Lyric : <span class="text-body"><a href="category-action.html">{{$top_slider->video->videodatail->lyrics}}</a></span>
                              </div>
                              <div class="text-primary title genres">
                                Music : <span class="text-body"><a href="category-action.html">{{$top_slider->video->videodatail->music_composition}}</a></span>
                              </div>
                              <div class="text-primary title tag">
                                 Tag: <span class="text-body">

                                    <a href="#">{{$top_slider->video->videodatail->tags}}</a>
                           ...
                           <div class="d-flex align-items-center r-mb-23" data-iq-gsap="onStart" data-iq-position-x="0" data-iq-position-y="150" data-iq-duration="1" data-iq-delay=".6">
                              <a href="{{ url('/details') }}/{{$top_slider->id}}/{{urlencode(Illuminate\Support\Str::slug($top_slider->title))}}" class="btn btn-hover iq-button"><i class="fa fa-play mr-2"
