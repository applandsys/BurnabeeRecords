                  ...
                  <div  class="swiper pt-2 pt-md-4 pt-lg-4 iq-rtl-direction" data-swiper="common-slider">
                     <ul class="swiper-wrapper p-0 m-0 ">
                        ...
                        <li class="swiper-slide slide-item">
                           <div class="block-images position-relative ">
                              <div class="img-box">
                                 <img src="{{ asset('assets/front_template/images/video/01.jpg')}}" class="img-fluid" alt="" loading="lazy">
                              </div>
                              <div class="block-description">
                                 <h6 class="iq-title"><a href="show-detail.html">{{$latest->title}}</a></h6>
                     ...
                     <!-- 
                        <li class="swiper-slide slide-item">
                           <div class="block-images position-relative ">
                              <div class="img-box">
                                 <img src="{{ asset('assets/front_template/images/video/02.jpg')}}" class="img-fluid" alt="" loading="lazy">
                              </div>
                              <div class="block-description">
                        ...
                        <li class="swiper-slide slide-item">
                           <div class="block-images position-relative ">
                              <div class="img-box">
                                 <img src="{{ asset('assets/front_template/images/video/06.jpg')}}" class="img-fluid" alt="" loading="lazy">
                              </div>
                              <div class="block-description">
                                 <h6 class="iq-title"><a href="show-detail.html">Narnia</a></h6>
                                 <div class="movie-time d-flex align-items-center my-2">
                        ...
                        <li class="swiper-slide slide-item">
                           <div class="block-images position-relative">
                              <div class="img-box">
                                 <img src="{{ asset('assets/front_template/images/video/07.jpg')}}" class="img-fluid" alt="" loading="lazy">
                              </div>
                              <div class="block-description">
                        ...
                        <li class="swiper-slide slide-item">
                           <div class="block-images position-relative">
                              <div class="img-box">
                                 <img src="{{ asset('assets/front_template/images/video/08.jpg')}}" class="img-fluid" alt="" loading="lazy">
                              </div>
                              <div class="block-description">
                        ...
                        <li class="swiper-slide slide-item">
                           <div class="block-images position-relative">
                              <div class="img-box">
                                 <img src="{{ asset('assets/front_template/images/video/09.jpg')}}" class="img-fluid" alt="" loading="lazy">
                              </div>
                              <div class="block-description">
                        ...
                        <li class="swiper-slide slide-item">
                           <div class="block-images position-relative">
                              <div class="img-box">
                                 <img src="{{ asset('assets/front_template/images/video/03.jpg')}}" class="img-fluid" alt="" loading="lazy">
                              </div>
                              <div class="block-description">
                                 <h6 class="iq-title"><a href="show-detail.html">X-Men</a></h6>
                                 <div class="movie-time d-flex align-items-center my-2">
                        ...
                        <li class="swiper-slide slide-item">
                           <div class="block-images position-relative">
                              <div class="img-box">
                                 <img src="{{ asset('assets/front_template/images/video/04.jpg')}}" class="img-fluid" alt="" loading="lazy">
                              </div>
                              <div class="block-description">
                                 <h6 class="iq-title"><a href="show-detail.html">Logan</a></h6>
                                 <div class="movie-time d-flex align-items-center my-2">
                        ...
                        <li class="swiper-slide slide-item">
                           <div class="block-images position-relative">
                              <div class="img-box">
                                 <img src="{{ asset('assets/front_template/images/video/05.jpg')}}" class="img-fluid" alt="" loading="lazy">
                              </div>
                              <div class="block-description">
                                 <h6 class="iq-title"><a href="show-detail.html">Black Queen</a></h6>
                                 <div class="movie-time d-flex align-items-center my-2">
                        ...
                        <li class="swiper-slide slide-item">
                           <div class="block-images position-relative ">
                              <div class="img-box">
                                 <img src="{{ asset('assets/front_template/images/video/10.jpg')}}" class="img-fluid" alt="" loading="lazy">
                              </div>
                              <div class="block-description">
                           ...
                           <div class="swiper-container " data-swiper="slider-thumbs-inner">
                              <div class="swiper-wrapper top-ten-slider-nav">
                                 <div class="swiper-slide swiper-bg">
                                    <div class="block-images position-relative ">
                                       <div class="img-box slider--image">
                                          <img src="{{ asset('assets/front_template/images/trending/07.jpg')}}" class="img-fluid" alt="" loading="lazy">
                                       </div>
                                       <div class="block-description">
                                          <h6 class="iq-title"><a href="show-detail.html">Shadow Warrior</a></h6>
                                          <div class="movie-time d-flex align-items-center my-2">
                                 ...
                                 <div class="swiper-slide swiper-bg">
                                    <div class="block-images position-relative ">
                                       <div class="img-box slider--image">
                                          <img src="{{ asset('assets/front_template/images/trending/08.jpg')}}" class="img-fluid" alt="" loading="lazy">
                                       </div>
                                       <div class="block-description">
                                          <h6 class="iq-title"><a href="show-detail.html">Narnia</a></h6>
                                          <div class="movie-time d-flex align-items-center my-2">
                                 ...
                                 <div class="swiper-slide swiper-bg">
                                    <div class="block-images position-relative">
                                       <div class="img-box slider--image">
                                          <img src="{{ asset('assets/front_template/images/trending/09.jpg')}}" class="img-fluid" alt="" loading="lazy">
                                       </div>
                                       <div class="block-description">
                                          <h6 class="iq-title"><a href="show-detail.html">X-Men</a></h6>
                                          <div class="movie-time d-flex align-items-center my-2">
                                 ...
                                 <div class="swiper-slide swiper-bg">
                                    <div class="block-images position-relative">
                                       <div class="img-box slider--image">
                                          <img src="{{ asset('assets/front_template/images/trending/10.jpg')}}" class="img-fluid" alt="" loading="lazy">
                                       </div>
                                       <div class="block-description">
                                          <h6 class="iq-title"><a href="show-detail.html">Logan</a></h6>
                                          <div class="movie-time d-flex align-items-center my-2">
                                 ...
                                 <div class="swiper-slide swiper-bg">
                                    <div class="block-images position-relative">
                                       <div class="img-box slider--image">
                                          <img src="{{ asset('assets/front_template/images/trending/11.jpg')}}" class="img-fluid" alt="" loading="lazy">
                                       </div>
                                       <div class="block-description">
                                          <h6 class="iq-title"><a href="show-detail.html">Black Queen</a></h6>
                                          <div class="movie-time d-flex align-items-center my-2">
                                 ...
                                 <div class="swiper-slide swiper-bg">
                                    <div class="block-images position-relative ">
                                       <div class="img-box slider--image">
                                          <img src="{{ asset('assets/front_template/images/trending/12.jpg')}}" class="img-fluid" alt="" loading="lazy">
                                       </div>
                                       <div class="block-description">
                                          <h6 class="iq-title"><a href="show-detail.html">Shadow Warrior</a></h6>
                                          <div class="movie-time d-flex align-items-center my-2">
                                 ...
                                 <div class="swiper-slide swiper-bg">
                                    <div class="block-images position-relative ">
                                       <div class="img-box slider--image">
                                          <img src="{{ asset('assets/front_template/images/trending/13.jpg')}}" class="img-fluid" alt="" loading="lazy">
                                       </div>
                                       <div class="block-description">
                                          <h6 class="iq-title"><a href="show-detail.html">Narnia</a></h6>
                                          <div class="movie-time d-flex align-items-center my-2">
                                 ...
                                 <div class="swiper-slide swiper-bg">
                                    <div class="block-images position-relative">
                                       <div class="img-box slider--image">
                                          <img src="{{ asset('assets/front_template/images/trending/14.jpg')}}" class="img-fluid" alt="" loading="lazy">
                                       </div>
                                       <div class="block-description">
                                          <h6 class="iq-title"><a href="show-detail.html">X-Men</a></h6>
                                          <div class="movie-time d-flex align-items-center my-2">
                                 ...
                                 <div class="swiper-slide swiper-bg">
                                    <div class="block-images position-relative">
                                       <div class="img-box slider--image">
                                          <img src="{{ asset('assets/front_template/images/trending/15.png')}}" class="img-fluid" alt="" loading="lazy">
                                       </div>
                                       <div class="block-description">
                                          <h6 class="iq-title"><a href="show-detail.html">Logan</a></h6>
                                          <div class="movie-time d-flex align-items-center my-2">
                        ...
                        <div class="swiper-container " data-swiper="slider-images-inner">
                           <div class="swiper-wrapper ">
                              <div class="swiper-slide">
                                 <div class="slider--image block-images"><img src="{{ asset('assets/front_template/images/trending/07.jpg')}}" loading="lazy" alt="" /></div>
                              ...
                              <div class="swiper-slide">
                                 <div class="slider--image block-images"><img src="{{ asset('assets/front_template/images/trending/08.jpg')}}" loading="lazy" alt="" /></div>
                                 <div class="description">
                                    <div class="block-description">
                              ...
                              <div class="swiper-slide">
                                 <div class="slider--image block-images"><img src="{{ asset('assets/front_template/images/trending/09.jpg')}}" loading="lazy" alt="" /></div>
                                 <div class="description">
                                    <div class="block-description">
                              ...
                              <div class="swiper-slide">
                                 <div class="slider--image block-images"><img src="{{ asset('assets/front_template/images/trending/10.jpg')}}" loading="lazy" alt="" /></div>
                                 <div class="description">
                                    <div class="block-description">
                              ...
                              <div class="swiper-slide">
                                 <div class="slider--image block-images"><img src="{{ asset('assets/front_template/images/trending/11.jpg')}}" loading="lazy" alt="" /></div>
                                 <div class="description">
                                    <div class="block-description">
                                       <h6 class="iq-title"><a href="show-detail.html">Worst Vampire</a></h6>
                                       <div class="movie-time d-flex align-items-center my-2">
                              ...
                              <div class="swiper-slide">
                                 <div class="slider--image block-images"><img src="{{ asset('assets/front_template/images/trending/12.jpg')}}" loading="lazy" alt="" /></div>
                                 <div class="description">
                                    <div class="block-description">
                                       <h6 class="iq-title"><a href="show-detail.html">Worst Vampire</a></h6>
                                       <div class="movie-time d-flex align-items-center my-2">
                              ...
                              <div class="swiper-slide">
                                 <div class="slider--image block-images"><img src="{{ asset('assets/front_template/images/trending/13.jpg')}}" loading="lazy" alt="" /></div>
                                 <div class="description">
                                    <div class="block-description">
                                       <h6 class="iq-title"><a href="show-detail.html">Worst Vampire</a></h6>
                                       <div class="movie-time d-flex align-items-center my-2">
                              ...
                              <div class="swiper-slide">
                                 <div class="slider--image block-images"><img src="{{ asset('assets/front_template/images/trending/14.jpg')}}" loading="lazy" alt="" /></div>
                                 <div class="description">
                                    <div class="block-description">
                                       <h6 class="iq-title"><a href="show-detail.html">Shadow Warrior</a></h6>
                                       <div class="movie-time d-flex align-items-center my-2">
                              ...
                              <div class="swiper-slide">
                                 <div class="slider--image block-images"><img src="{{ asset('assets/front_template/images/trending/15.png')}}" loading="lazy" alt="" /></div>
                                 <div class="description">
                                    <div class="block-description">
                                       <h6 class="iq-title"><a href="show-detail.html">Shadow Warrior</a></h6>
                                       <div class="movie-time d-flex align-items-center my-2">
                  ...
                  <div  class="swiper pt-2 pt-md-4 pt-lg-4 iq-rtl-direction" data-swiper="common-slider">
                     <ul class="swiper-wrapper p-0 m-0">
                        <li class="swiper-slide slide-item">
                           <div class="block-images position-relative">
                              <div class="img-box">
                                 <img src="{{ asset('assets/front_template/images/video/03.jpg')}}" class="img-fluid" loading="lazy" alt="">
                              </div>
                              <div class="block-description">
                                 <h6 class="iq-title"><a href="show-detail.html">X-Men</a></h6>
                                 <div class="movie-time d-flex align-items-center my-2">
                        ...
                        <li class="swiper-slide slide-item">
                           <div class="block-images position-relative">
                              <div class="img-box">
                                 <img src="{{ asset('assets/front_template/images/video/04.jpg')}}" class="img-fluid" loading="lazy" alt="">
                              </div>
                              <div class="block-description">
                                 <h6 class="iq-title"><a href="show-detail.html">Logan</a></h6>
                                 <div class="movie-time d-flex align-items-center my-2">
                        ...
                        <li class="swiper-slide slide-item">
                           <div class="block-images position-relative ">
                              <div class="img-box">
                                 <img src="{{ asset('assets/front_template/images/video/01.jpg')}}" class="img-fluid" loading="lazy" alt="">
                              </div>
                              <div class="block-description">
                                 <h6 class="iq-title"><a href="show-detail.html">Shadow Warrior</a></h6>
                                 <div class="movie-time d-flex align-items-center my-2">
                        ...
                        <li class="swiper-slide slide-item">
                           <div class="block-images position-relative ">
                              <div class="img-box">
                                 <img src="{{ asset('assets/front_template/images/video/02.jpg')}}" loading="lazy" class="img-fluid" alt="">
                              </div>
                              <div class="block-description">
                                 <h6 class="iq-title"><a href="show-detail.html">Narnia</a></h6>
                                 <div class="movie-time d-flex align-items-center my-2">
                        ...
                        <li class="swiper-slide slide-item">
                           <div class="block-images position-relative">
                              <div class="img-box">
                                 <img src="{{ asset('assets/front_template/images/video/05.jpg')}}" loading="lazy" class="img-fluid" alt="">
                              </div>
                              <div class="block-description">
                                 <h6 class="iq-title"><a href="show-detail.html">Black Queen</a></h6>
                                 <div class="movie-time d-flex align-items-center my-2">
                        ...
                        <li class="swiper-slide slide-item">
                           <div class="block-images position-relative ">
                              <div class="img-box">
                                 <img src="{{ asset('assets/front_template/images/video/10.jpg')}}" loading="lazy" class="img-fluid" alt="">
                              </div>
                              <div class="block-description">
                                 <h6 class="iq-title"><a href="show-detail.html">Shadow Warrior</a></h6>
                                 <div class="movie-time d-flex align-items-center my-2">
                        ...
                        <li class="swiper-slide slide-item">
                           <div class="block-images position-relative ">
                              <div class="img-box">
                                 <img src="{{ asset('assets/front_template/images/video/06.jpg')}}" loading="lazy" class="img-fluid" alt="">
                              </div>
                              <div class="block-description">
                                 <h6 class="iq-title"><a href="show-detail.html">Narnia</a></h6>
                                 <div class="movie-time d-flex align-items-center my-2">
                        ...
                        <li class="swiper-slide slide-item">
                           <div class="block-images position-relative">
                              <div class="img-box">
                                 <img src="{{ asset('assets/front_template/images/video/07.jpg')}}"  loading="lazy" class="img-fluid" alt="">
                              </div>
                              <div class="block-description">
                                 <h6 class="iq-title"><a href="show-detail.html">X-Men</a></h6>
                                 <div class="movie-time d-flex align-items-center my-2">
                        ...
                        <li class="swiper-slide slide-item">
                           <div class="block-images position-relative">
                              <div class="img-box">
                                 <img src="{{ asset('assets/front_template/images/video/08.jpg')}}" loading="lazy" class="img-fluid" alt="">
                              </div>
                              <div class="block-description">
                                 <h6 class="iq-title"><a href="show-detail.html">Logan</a></h6>
                                 <div class="movie-time d-flex align-items-center my-2">
                        ...
                        <li class="swiper-slide slide-item">
                           <div class="block-images position-relative">
                              <div class="img-box">
                                 <img src="{{ asset('assets/front_template/images/video/09.jpg')}}" loading="lazy" class="img-fluid" alt="">
                              </div>
                              <div class="block-description">
                                 <h6 class="iq-title"><a href="show-detail.html">Black Queen</a></h6>
                                 <div class="movie-time d-flex align-items-center my-2">
                  ...
                  <div  class="swiper pt-2 pt-md-4 pt-lg-4 iq-rtl-direction" data-swiper="common-slider">
                     <ul class="swiper-wrapper p-0 m-0">
                        <li class="swiper-slide slide-item">
                           <div class="block-images position-relative ">
                              <div class="img-box">
                                 <img src="{{ asset('assets/front_template/images/video/01.jpg')}}" loading="lazy" class="img-fluid" alt="">
                              </div>
                              <div class="block-description">
                                 <h6 class="iq-title"><a href="show-detail.html">Shadow Warrior</a></h6>
                                 <div class="movie-time d-flex align-items-center my-2">
                        ...
                        <li class="swiper-slide slide-item">
                           <div class="block-images position-relative">
                              <div class="img-box">
                                 <img src="{{ asset('assets/front_template/images/video/04.jpg')}}" loading="lazy" class="img-fluid" alt="">
                              </div>
                              <div class="block-description">
                                 <h6 class="iq-title"><a href="show-detail.html">Logan</a></h6>
                                 <div class="movie-time d-flex align-items-center my-2">
                        ...
                        <li class="swiper-slide slide-item">
                           <div class="block-images position-relative">
                              <div class="img-box">
                                 <img src="{{ asset('assets/front_template/images/video/03.jpg')}}" loading="lazy" class="img-fluid" alt="">
                              </div>
                              <div class="block-description">
                                 <h6 class="iq-title"><a href="show-detail.html">X-Men</a></h6>
                                 <div class="movie-time d-flex align-items-center my-2">
