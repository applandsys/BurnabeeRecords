                     ...
                     <div class="iq-blog-box">
                        ...
                        <div class="iq-blog-detail">
                           ...
                           <div class="blog-button">
                              <a class="button-link" href="{{route('home.blogdetail',['id'=>$list->id,'slug'=>Illuminate\Support\Str::slug('blog slug')] )}}">Read More<i class="fa fa-angle-right" aria-hidden="true"></i></a>
                           </div>
                           <ul class="iq-blogcat">
               ...
               <div class="col-lg-4 col-sm-12">
                  <div class="widget-area" >
                     ...
                     <div class="iq-widget-menu widget">
                                 ...
                                 <li>
                                    <div class="post-img">
                                       <div class="post-img-holder">
                                          <a href="#" style="background-image: url('{{ asset('uploads/blog/thumbnail')}}/{{$post->featured_image}}');"></a>
                                       </div>
                                       <div class="post-blog">
                                          <div class="blog-box">
                                             <ul class="list-inline">
                                                <li class="list-inline-item  mr-3 border-0">
                                                   <a class="date-widget" href="#"><i class="fa fa-calendar mr-2" aria-hidden="true"></i>{{ \Carbon\Carbon::parse($post->created_at)->format('d M Y')}}</a>
                                                </li>
                                             </ul>
                                             <a class="new-link" href="blog-details.html"><h6>{{$post->blog_title}}</h6></a>
                                          </div>
                                       </div>
                                    </div>
                                 </li>
                        ...
                        <!-- <div id="tag_cloud-2" class="widget widget_tag_cloud"><h5 class="widget-title">Tags</h5> -->
                        <!-- <div class="tagcloud">
                     ...
                     <div id="recent-posts-2" class="widget widget_recent_entries">
                        ...
                        @foreach($recent_post as $post)
                           <li>
                              <a href="{{route('home.blogdetail',['id'=>$list->id,'slug'=>Illuminate\Support\Str::slug('blog slug')] )}}">{{$post->title}}</a>
                           </li>
                        @endforeach
                        </ul>
                     </div>
